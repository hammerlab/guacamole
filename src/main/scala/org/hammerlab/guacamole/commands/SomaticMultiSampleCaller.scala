...
import org.kohsuke.args4j.{Option => Opt, Argument}

/**
 * Multisample somatic caller
 *
 */

object SomaticMultiSampleCaller {
  ...
  object Caller extends SparkCommand[Arguments] {
    override val name = "somatic-multisample"
    override val description = "call variants appearing in any subset of samples"
