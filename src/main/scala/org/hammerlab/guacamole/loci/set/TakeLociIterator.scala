...
import org.hammerlab.guacamole.readsets.iterator.ContigsIterator
import org.hammerlab.guacamole.reference.{ContigIterator, ContigName, HasLocus, Interval, IntervalImpl, Locus, Position}
