...
import org.hammerlab.guacamole.reads.{MappedRead, MappedReadSerializer, MateAlignmentProperties, PairedMappedRead, PairedRead, Read, UnmappedRead, UnmappedReadSerializer}
...
class GuacamoleKryoRegistrator extends KryoRegistrator {
  override def registerClasses(kryo: Kryo) {
    ...
    kryo.register(classOf[PairedMappedRead])
