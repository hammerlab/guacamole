...
class RegionSuite
  ...
  test("overlapping reads") {
    val read1 = makeRead("TCGATCGA", cigar = "8M", start = 1L)
    val read2 = makeRead("TCGATCGA", cigar = "8M", start = 5L)
  ...
  test("overlapping reads, different contigs") {
    val read1 = makeRead("TCGATCGA", cigar = "8M", start = 1L)
    val read2 = makeRead("TCGATCGA", cigar = "8M", start = 5L, chr = "chr2")
  ...
  test("nonoverlapping reads") {
    val read1 = makeRead("TCGATCGA", cigar = "8M", start = 1L)
    val read2 = makeRead("TCGATCGA", cigar = "8M", start = 10L)
  ...
  test("overlapping reads on start") {
    val read1 = makeRead("TCGATCGA", cigar = "8M", start = 1L)
    val read2 = makeRead("TCGATCGA", cigar = "8M", start = 8L)
  ...
  test("read completely covers another") {
    val read1 = makeRead("TCGATCGA", cigar = "8M", start = 1L)
    val read2 = makeRead("TCG", cigar = "3M", start = 5L)
