...
import org.bdgenomics.guacamole.{ LociSet, Pileup, SlidingReadWindow }
...
trait VariantCaller extends Serializable {
   ...
   *
   */
  def callVariants(reads: SlidingReadWindow, loci: LociSet.SingleContig): Iterator[ADAMGenotype]
}
