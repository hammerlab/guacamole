...
class run_M2_dream extends QScript {
  ...
  var scatter: Int = 10 
    ...
    mutect2.reference_sequence = new File("human_g1k_v37.fasta")
    mutect2.cosmic :+= new File("b37_cosmic_v54_120711.vcf")
    mutect2.dbsnp = new File("dbsnp_132_b37.leftAligned.vcf")
    mutect2.normal_panel :+= new File("mutect_noise.vcf")
